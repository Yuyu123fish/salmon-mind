...
class KnowledgeExceptionHandler {
    ...
    private static HttpStatus statusOf(KnowledgeException.Code code) {
        return switch (code) {
            ...
            case UPLOAD_SESSION_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case UPLOAD_SESSION_EXPIRED -> HttpStatus.GONE;
            case DOCUMENT_NOT_READY, REVISION_NOT_RETRYABLE, DOCUMENT_DELETE_NOT_ALLOWED -> HttpStatus.CONFLICT;
            case UPLOAD_SESSION_CONFLICT, UPLOAD_INCOMPLETE -> HttpStatus.CONFLICT;
            case UPLOAD_CHECKSUM_MISMATCH, UPLOAD_FINAL_VALIDATION_FAILED -> HttpStatus.UNPROCESSABLE_ENTITY;
            ...
            case OBJECT_STORAGE_UNAVAILABLE, KNOWLEDGE_QUEUE_UNAVAILABLE,
                    ...
                    UPLOAD_STATE_UNAVAILABLE, RESUMABLE_UPLOAD_DISABLED ->
