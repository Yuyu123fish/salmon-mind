 ...
 * 列表、详情和后续 Agent 可见。用户已命名的调用链默认受保护；只有明确授权时
 * {@code allowUserNameOverride} 才允许 Agent 改名。</p>
 */
public record CallChainPrepareRequest(
    ...
    public CallChainPrepareRequest(
        ...
        this(repositoryId, expectedObservation, name, nodes, edges,
                originConversationId, originAnswerEntryId, false);
    }
